      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-amber-100 shadow-sm px-8 py-10 flex flex-col items-center text-center">
          ...
          <button
            ...
            className="mt-3 w-full flex items-center justify-center gap-3 rounded-xl bg-white border border-stone-200 px-5 py-3 text-sm font-semibold text-stone-700 hover:bg-stone-50 active:bg-stone-100 transition-colors"
          >
