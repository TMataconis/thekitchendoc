      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-amber-100 shadow-sm px-8 py-10 flex flex-col items-center text-center">
          ...
          <button
            ...
            className="mt-3 w-full flex items-center justify-center gap-3 rounded-xl bg-stone-900 px-5 py-3 text-sm font-semibold text-white hover:bg-stone-700 active:bg-stone-800 transition-colors"
          >
            <svg
              viewBox="0 0 24 24"
              width="18"
